    ...
    <header style={{
      ...
      <div className="container" style={{
        ...
        >
          ...
          >
            {theme === 'light' ? (
              <Moon size={20} color="currentColor" strokeWidth={2} />
            ) : (
              <Sun size={20} color="currentColor" strokeWidth={2} />
            )}
          </motion.div>
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ShoppingBag size={20} color="currentColor" strokeWidth={2} />
          Explorar Coleção
        </motion.button>
      </motion.div>
    </motion.section>
      ...
      <div style={{ padding: 'var(--space-4)' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-1)' }}>
            <Star size={16} fill="var(--accent-400)" color="var(--accent-400)" strokeWidth={0} />
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 'var(--space-1)', marginBottom: 'var(--space-3)' }}>
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star key={i} size={16} fill="var(--accent-400)" color="var(--accent-400)" strokeWidth={0} />
                ))}
              </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
              <Instagram size={24} color="currentColor" strokeWidth={2} style={{ cursor: 'pointer' }} />
              <Facebook size={24} color="currentColor" strokeWidth={2} style={{ cursor: 'pointer' }} />
              <Heart size={24} color="currentColor" strokeWidth={2} style={{ cursor: 'pointer' }} />
              <Mail size={24} color="currentColor" strokeWidth={2} style={{ cursor: 'pointer' }} />
            </div>
          </div>
